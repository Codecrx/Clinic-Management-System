...
def update_patient_details():
    ...
    if int(pid_to_update) in patient_data['Patient_ID'].values:
        ...
        index_to_update = patient_data.index[patient_data['Patient_ID'] == int(pid_to_update)].tolist()[0]
...
def patient_login():
    ...
    # Use the correct dataframe name ('patient_data' instead of 'Patient_Data')
